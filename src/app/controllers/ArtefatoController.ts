...
class ArtefatoController {
    ...
    async store(req: Request, res: Response){
        ...
        if(type == "Arma"){
            ...
            const a = repository.create(req.body); //cria a entidade Jogador

            await repository.save(a); //persiste a entidade na tabela.
    ...
    async list(req: Request, res: Response){
        ...
        const lista = await repository.createQueryBuilder('tb_artefato').getMany();
